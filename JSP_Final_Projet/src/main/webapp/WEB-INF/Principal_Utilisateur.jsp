					  ...
					  <div class="collapse navbar-collapse" id="navbarNav">
					    ...
					    <ul class="navbar-nav">
					      ...
					      <li class="nav-item" style="margin-left:30px">
							<a class="btn btn-outline-dark" href="Connexion_Application?action_bouton=Add_Materiel_Form" target="myFrame"><i style="margin-right: 10px" class="fa fa-list" aria-hidden="true"></i>| Ajouter Materiel |</a>
						
							</li>
					      
					      <li style="margin-left: 30px" class="nav-item" >
							<a class="btn btn-outline-dark" href="Connexion_Application?action_bouton=List_Materiel_Form" target="myFrame"><i style="margin-right: 10px" class="fa fa-list" aria-hidden="true"></i>| Consulter la liste |</a>
						  ...
						  <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
						    <a class="dropdown-item" href="Connexion_Application?action_bouton=Rechercher_Materiel" target="myFrame">Rechercher un Materiel</a>
